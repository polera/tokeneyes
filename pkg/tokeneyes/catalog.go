...
const CatalogVersion = "2026-07-19"
...
func DefaultCatalog() Catalog {
	return Catalog{Version: CatalogVersion, Models: []Model{
		{ID: "gpt-5.6", Aliases: []string{"gpt-5.6-sol"}, Provider: "openai", Tokenizer: "o200k_base", ContextWindow: 1_050_000, MaxOutput: 128_000, PricingDate: CatalogVersion, Verification: "none", Tiers: openAILongContextTiers(5_000_000, 500_000, 30_000_000), Media: openAIMedia(1, 0, 0, true)},
		{ID: "gpt-5.6-terra", Aliases: []string{"terra"}, Provider: "openai", Tokenizer: "o200k_base", ContextWindow: 1_050_000, MaxOutput: 128_000, PricingDate: CatalogVersion, Verification: "none", Tiers: openAILongContextTiers(2_500_000, 250_000, 15_000_000), Media: openAIMedia(1, 0, 0, true)},
		{ID: "gpt-5.6-luna", Aliases: []string{"luna"}, Provider: "openai", Tokenizer: "o200k_base", ContextWindow: 1_050_000, MaxOutput: 128_000, PricingDate: CatalogVersion, Verification: "none", Tiers: openAILongContextTiers(1_000_000, 100_000, 6_000_000), Media: openAIMedia(1, 0, 0, true)},
		{ID: "gpt-5.5", Aliases: []string{"codex", "openai"}, Provider: "openai", Tokenizer: "o200k_base", ContextWindow: 1_050_000, MaxOutput: 128_000, PricingDate: CatalogVersion, Verification: "none", Tiers: openAILongContextTiers(5_000_000, 500_000, 30_000_000), Media: openAIMedia(1, 10_000, 6_000, true)},
		{ID: "gpt-5.4", Aliases: []string{"gpt"}, Provider: "openai", Tokenizer: "o200k_base", ContextWindow: 1_050_000, MaxOutput: 128_000, PricingDate: CatalogVersion, Verification: "none", Tiers: openAILongContextTiers(2_500_000, 250_000, 15_000_000), Media: openAIMedia(1, 10_000, 6_000, false)},
		...
		{ID: "gpt-5.4-nano", Aliases: []string{"nano"}, Provider: "openai", Tokenizer: "o200k_base", ContextWindow: 400_000, MaxOutput: 128_000, PricingDate: CatalogVersion, Verification: "none", Tiers: []PriceTier{{InputMicrosPerMTok: 200_000, CachedMicrosPerMTok: 20_000, OutputMicrosPerMTok: 1_250_000}}, Media: openAIMedia(1.62, 1_536, 0, false)},
		{ID: "claude-fable-5", Aliases: []string{"fable"}, Provider: "anthropic", Tokenizer: "claude-estimator-v2", ContextWindow: 1_000_000, MaxOutput: 128_000, PricingDate: CatalogVersion, Verification: "anthropic-count", Tiers: []PriceTier{{InputMicrosPerMTok: 10_000_000, CachedMicrosPerMTok: 1_000_000, OutputMicrosPerMTok: 50_000_000}}, Media: anthropicMedia(2_576, 4_784)},
		...
		{ID: "gemini-3.1-pro-preview", Aliases: []string{"gemini", "gemini-pro"}, Provider: "google", Tokenizer: "gemini-estimator-v1", ContextWindow: 1_048_576, MaxOutput: 65_536, PricingDate: CatalogVersion, Verification: "gemini-count", Tiers: []PriceTier{{InputMicrosPerMTok: 2_000_000, CachedMicrosPerMTok: 200_000, OutputMicrosPerMTok: 12_000_000}, {AboveInputTokens: 200_001, InputMicrosPerMTok: 4_000_000, CachedMicrosPerMTok: 400_000, OutputMicrosPerMTok: 18_000_000}}, Media: geminiMedia()},
		...
		{ID: "gemini-2.5-pro", Provider: "google", Tokenizer: "gemini-estimator-v1", ContextWindow: 1_048_576, MaxOutput: 65_536, PricingDate: CatalogVersion, Verification: "gemini-count", Tiers: []PriceTier{{InputMicrosPerMTok: 1_250_000, CachedMicrosPerMTok: 125_000, OutputMicrosPerMTok: 10_000_000}, {AboveInputTokens: 200_001, InputMicrosPerMTok: 2_500_000, CachedMicrosPerMTok: 250_000, OutputMicrosPerMTok: 15_000_000}}, Media: geminiMedia()},
		{ID: "gemini-2.5-flash", Provider: "google", Tokenizer: "gemini-estimator-v1", ContextWindow: 1_048_576, MaxOutput: 65_536, PricingDate: CatalogVersion, Verification: "gemini-count", Tiers: []PriceTier{{InputMicrosPerMTok: 300_000, CachedMicrosPerMTok: 30_000, OutputMicrosPerMTok: 2_500_000}}, ModalityTiers: map[string][]PriceTier{"audio": {{InputMicrosPerMTok: 1_000_000, CachedMicrosPerMTok: 100_000, OutputMicrosPerMTok: 2_500_000}}}, Media: geminiMedia()},
		{ID: "gemini-2.5-flash-lite", Provider: "google", Tokenizer: "gemini-estimator-v1", ContextWindow: 1_048_576, MaxOutput: 65_536, PricingDate: CatalogVersion, Verification: "gemini-count", Tiers: []PriceTier{{InputMicrosPerMTok: 100_000, CachedMicrosPerMTok: 10_000, OutputMicrosPerMTok: 400_000}}, ModalityTiers: map[string][]PriceTier{"audio": {{InputMicrosPerMTok: 300_000, CachedMicrosPerMTok: 30_000, OutputMicrosPerMTok: 400_000}}}, Media: geminiMedia()},
	}}
}

func openAILongContextTiers(input, cached, output int64) []PriceTier {
	return []PriceTier{
		{InputMicrosPerMTok: input, CachedMicrosPerMTok: cached, OutputMicrosPerMTok: output},
		{AboveInputTokens: 272_001, InputMicrosPerMTok: 2 * input, CachedMicrosPerMTok: 2 * cached, OutputMicrosPerMTok: 3 * output / 2},
	}
}
